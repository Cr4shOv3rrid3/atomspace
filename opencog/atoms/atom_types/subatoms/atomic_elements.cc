...
element.push_back("Proton");
element.push_back("Neutron");
element.push_back("Electron"); //see appropriate subatomic_elements.cc line where it is mentioned as well!
//and the graphics designer understands the Atom as the following!
element.push_back("Pixel"); //word creation stands for: Picture element!
